  ...
  return (
    ...
    >
      ...
      <div className="mt-6 rounded-lg">
        <img
          className="grayscale overflow-hidden rounded-lg"
          src={profile}
          alt=""
        />
      </div>
