  ...
  return (
    ...
    >
      ...
      <div className="mt-6 md:flex md:justify-between md:items-center md:mt-11">
        ...
        <div
          className={`grid grid-cols-3 gap-10 basis-2/4 ${
            mode ? " text-body" : " text-white"
          }`}
        >
          <div className="flex flex-col items-center w-1/2">
            <img src={react} />
            <p className="mt-4 text-xl font-bold">React</p>
          </div>
          <div className="flex flex-col items-center w-1/2">
            <img src={css} />
            <p className="mt-4 text-xl font-bold">CSS</p>
          </div>
          <div className="flex flex-col items-center w-1/2">
            <img src={js} />
            <p className="mt-4 text-xl font-bold">JavaScript</p>
          </div>
          <div className="flex flex-col items-center w-1/2">
            <img src={tailwind} />
            <p className="mt-4 text-xl font-bold">TailWind</p>
          </div>
          <div className="flex flex-col items-center w-1/2">
            <img className="w-1/2" src={html} />
            <p className="mt-4 text-xl font-bold">HTML</p>
          </div>
        </div>
      </div>
    </div>
